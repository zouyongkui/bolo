	...
	var O = function(h) {
			...
			function Y(a) {
				...
				if (r.outerWidth() < g) {
					...
					if (w && (j.scrollHeight > j.offsetHeight || "scroll" == q.css("overflow-y"))) u.width = s(v - f);
			...
			function Ga(a) {
				...
				if (!k && !f && !d && i == aa(a) && i == j.length) for (o = 0; o < i; o++) c[o].sWidth = s(j.eq(o).width());
					...
					for (o = 0; o < e.length; o++) m = c[e[o]], j[o].style.width = null !== m.sWidthOrig && "" !== m.sWidthOrig ? s(m.sWidthOrig) : "";
				...
				if (!0 === a) this.child.show();
					...
					var e = c[0],
						...
						f = function(a, b) {
							...
							h) for (var c = 0, k = a.length; c < k; c++) f(a[c], b);
